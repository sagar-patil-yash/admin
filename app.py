...
def login():
    ...
    db = mysql.connector.connect(host=" sql6.freesqldatabase.com", user="sql6525423", passwd="M187CfIS7G", database="sql6525423")
    mycur = db.cursor()
...
def upload_file():
   if request.method == 'POST':
       ...
       db = mysql.connector.connect(host="ShowStoppers.mysql.pythonanywhere-services.com", user="ShowStoppers", passwd="SAGAR2002", database="ShowStoppers$MOVIEINFO")
       mycur = db.cursor()
       sel = 'SELECT * FROM '
       try:
...
def newm():
    ...
    dbm = mysql.connector.connect(host="ShowStoppers.mysql.pythonanywhere-services.com", user="ShowStoppers", passwd="SAGAR2002", database="ShowStoppers$MOVIEINFO")
...
def re():
    ...
    dbu = mysql.connector.connect(host="ShowStoppers.mysql.pythonanywhere-services.com", user="ShowStoppers", passwd="SAGAR2002", database="ShowStoppers$USER")
